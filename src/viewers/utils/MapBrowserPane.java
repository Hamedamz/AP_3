...
public class MapBrowserPane extends Pane {
    ...
    public void initialize() {
        ...
        viewPort = new Rectangle2D((imageProperties.getWidth() - Const.WINDOW_WIDTH *
                RESET_VIEWPOINT_TO_CAMERA_MULTIPLIER) / 2,
                (imageProperties.getHeight() - Const.WINDOW_HEIGHT *
                        RESET_VIEWPOINT_TO_CAMERA_MULTIPLIER) / 2,
                Const.WINDOW_WIDTH * RESET_VIEWPOINT_TO_CAMERA_MULTIPLIER,
                Const.WINDOW_HEIGHT * RESET_VIEWPOINT_TO_CAMERA_MULTIPLIER);
...
//        scale.setPivotY((viewPort.getMinY() + viewPort.getMaxY()) / 2);
        ...
        scale.setX(Const.WINDOW_WIDTH / viewPort.getWidth());
        scale.setY(Const.WINDOW_HEIGHT / viewPort.getHeight());
